...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  custom_field_service = client.GetService(
      'CustomFieldService', version='v201902')

  line_item_service = client.GetService('LineItemService', version='v201902')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v201902')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v201902')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v201902')
                         .Where('id = :lineItemId')
