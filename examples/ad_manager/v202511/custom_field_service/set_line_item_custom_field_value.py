...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202511')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202511')
                         .Where('id = :lineItemId')
