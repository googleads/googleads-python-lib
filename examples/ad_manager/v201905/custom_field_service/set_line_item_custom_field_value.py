...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  custom_field_service = client.GetService(
      'CustomFieldService', version='v201905')

  line_item_service = client.GetService('LineItemService', version='v201905')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v201905')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v201905')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v201905')
                         .Where('id = :lineItemId')
...
if __name__ == '__main__':
  ...
  main(ad_manager_client, CUSTOM_FIELD_ID, DROP_DOWN_CUSTOM_FIELD_ID,
       CUSTOM_FIELD_OPTION_ID, LINE_ITEM_ID)
