...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  line_item_service = client.GetService('LineItemService', version='v202402')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v202402')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202402')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202402')
                         .Where('id = :lineItemId')
