...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202405')
                         .Where('id = :lineItemId')
