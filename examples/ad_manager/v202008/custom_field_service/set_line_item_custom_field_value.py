...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  custom_field_statement = (ad_manager.StatementBuilder(version='v202008')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202008')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202008')
                         .Where('id = :lineItemId')
