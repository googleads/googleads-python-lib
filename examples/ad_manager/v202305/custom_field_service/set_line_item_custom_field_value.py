...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202305')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202305')
                         .Where('id = :lineItemId')
