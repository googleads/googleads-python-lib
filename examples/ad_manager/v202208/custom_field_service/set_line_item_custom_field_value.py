...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  line_item_service = client.GetService('LineItemService', version='v202208')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v202208')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202208')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202208')
                         .Where('id = :lineItemId')
