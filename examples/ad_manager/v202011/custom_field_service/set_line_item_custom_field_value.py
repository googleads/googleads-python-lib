...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  custom_field_service = client.GetService(
      'CustomFieldService', version='v202011')

  line_item_service = client.GetService('LineItemService', version='v202011')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v202011')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202011')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202011')
                         .Where('id = :lineItemId')
