...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  custom_field_service = client.GetService(
      'CustomFieldService', version='v202311')

  line_item_service = client.GetService('LineItemService', version='v202311')

  # Create statement to get a custom field.
  custom_field_statement = (ad_manager.StatementBuilder(version='v202311')
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202311')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202311')
                         .Where('id = :lineItemId')
