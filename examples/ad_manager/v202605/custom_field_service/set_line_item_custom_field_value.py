...
def main(client, custom_field_id, drop_down_custom_field_id,
  ...
  drop_down_custom_field_statement = (
      ad_manager.StatementBuilder(version='v202605')
  ...
  line_item_statement = (ad_manager.StatementBuilder(version='v202605')
                         .Where('id = :lineItemId')
