...
"""Initializes an DfpClient using GoogleAccessTokenClient.
...
parser = argparse.ArgumentParser(
    description=('Creates an DfpClient using a GoogleAccessToken with an '
...
parser.add_argument('--application_name', default=DEFAULT_APPLICATION_NAME,
                    help='The application name for your DFP account.')
