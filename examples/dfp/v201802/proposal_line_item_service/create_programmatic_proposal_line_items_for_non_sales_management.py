...
"""Creates a programmatic proposal line item for non-sales management.
"""
...
def main(client, proposal_id, product_id):
  proposal_line_item_service = client.GetService(
      'ProposalLineItemService', version='v201802')
  network_service = client.GetService('NetworkService', version='v201802')
...
if __name__ == '__main__':
  ...
  main(dfp_client, PROPOSAL_ID, PRODUCT_ID)
