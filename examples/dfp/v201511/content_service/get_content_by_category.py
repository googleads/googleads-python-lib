...
def main(client):
  ...
  content_service = client.GetService('ContentService', version='v201511')
  network_service = client.GetService('NetworkService', version='v201511')
  custom_targeting_service = client.GetService(
      'CustomTargetingService', version='v201511')
