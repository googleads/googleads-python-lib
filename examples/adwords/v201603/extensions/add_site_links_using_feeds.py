...
def main(client, campaign_id):
  ...
  feed_service = client.GetService('FeedService', version='v201603')
  feed_item_service = client.GetService('FeedItemService', version='v201603')
  feed_mapping_service = client.GetService(
      'FeedMappingService', version='v201603')
  campaign_feed_service = client.GetService(
      'CampaignFeedService', version='v201603')
