...
def main(client, adgroup_id):
  ...
  batch_job_helper = client.GetBatchJobHelper(version='v201702')
  # Create a BatchJob.
...
def AddBatchJob(client):
  ...
  batch_job_service = client.GetService('BatchJobService', version='v201702')
  # Create a BatchJob.
...
def CancelBatchJob(client, batch_job, max_poll_attempts=MAX_POLL_ATTEMPTS):
  ...
  """
  batch_job_service = client.GetService('BatchJobService', 'v201702')
