...
def CreateExtensionSetting(client, feed_items, campaign_feed, feed_item_ids,
  ...
  campaign_extension_setting_service = client.GetService(
      'CampaignExtensionSettingService', 'v201702')
...
def DeleteCampaignFeed(client, campaign_feed):
  ...
  """
  campaign_feed_service = client.GetService('CampaignFeedService', 'v201702')
...
def DeleteOldFeedItems(client, feed_item_ids, feed):
  ...
  feed_item_service = client.GetService('FeedItemService', 'v201702')
...
def GetFeeds(client):
  ...
  """
  feed_service = client.GetService('FeedService', 'v201702')
...
def GetFeedMapping(client, feed, placeholder_type):
  ...
  """
  feed_mapping_service = client.GetService('FeedMappingService', 'v201702')
