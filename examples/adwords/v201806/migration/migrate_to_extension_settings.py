...
def DeleteCampaignFeed(client, campaign_feed):
  ...
  """
  campaign_feed_service = client.GetService('CampaignFeedService', 'v201806')
...
def GetFeeds(client):
  ...
  """
  feed_service = client.GetService('FeedService', 'v201806')
...
def GetFeedMapping(client, feed, placeholder_type):
  ...
  """
  feed_mapping_service = client.GetService('FeedMappingService', 'v201806')
