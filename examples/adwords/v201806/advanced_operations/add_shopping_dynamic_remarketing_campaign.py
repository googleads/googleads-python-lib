...
def CreateCampaign(client, merchant_id, budget_id):
  ...
  """
  campaign_service = client.GetService('CampaignService', 'v201806')
...
def CreateAdGroup(client, campaign_id):
  ...
  """
  ad_group_service = client.GetService('AdGroupService', 'v201806')
...
def CreateAd(client, opener, ad_group_id):
  ...
  """
  ad_group_ad_service = client.GetService('AdGroupAdService', 'v201806')
  media_service = client.GetService('MediaService', 'v201806')
...
def AttachUserList(client, ad_group_id, user_list_id):
  ...
  ad_group_criterion_service = client.GetService(
      'AdGroupCriterionService', 'v201806')
