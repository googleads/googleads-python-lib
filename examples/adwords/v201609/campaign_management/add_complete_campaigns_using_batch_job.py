...
def main(client, number_of_campaigns, number_of_adgroups, number_of_keywords):
  ...
  batch_job_helper = client.GetBatchJobHelper(version='v201609')
...
def AddBatchJob(client):
  ...
  batch_job_service = client.GetService('BatchJobService', version='v201609')
  # Create a BatchJob.
...
def GetBatchJob(client, batch_job_id):
  ...
  """
  batch_job_service = client.GetService('BatchJobService', 'v201609')
