...
def main(client, campaign_id, ad_group_id):
  ...
  experiment_service = client.GetService('ExperimentService', version='v201409')
  ad_group_service = client.GetService('AdGroupService', version='v201409')
  ad_group_criterion_service = client.GetService(
      'AdGroupCriterionService', version='v201409')
