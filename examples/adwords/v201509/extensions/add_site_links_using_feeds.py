...
def main(client, campaign_id):
  ...
  feed_service = client.GetService('FeedService', version='v201509')
  feed_item_service = client.GetService('FeedItemService', version='v201509')
  feed_mapping_service = client.GetService(
      'FeedMappingService', version='v201509')
  campaign_feed_service = client.GetService(
      'CampaignFeedService', version='v201509')
