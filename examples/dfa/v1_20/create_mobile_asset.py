...
"""This example creates a mobile creative asset in a given advertiser.

Currently only gif, jpg, jpeg, png and wbmp files are supported as mobile
assets. To create an advertiser, run create_advertiser.py.
...
def main(client, advertiser_id, asset_name, path_to_file):
  ...
  result = creative_service.saveCreativeAsset(image_asset)
